        ...
        <div className="w-screen h-screen bg-gradient-to-br from-black via-zinc-900 to-blue-900 text-white">
            <div className="w-full h-full p-6 flex flex-col space-y-6 overflow-y-auto">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <Link to='/login' className="w-full md:w-auto mt-4 md:mt-0">
                        <button
                            onClick={handleLogout}
                            className="bg-red-600 hover:bg-red-700 w-full sm:w-auto px-4 py-2 rounded-md text-sm font-medium text-black transition duration-300"
                        >
                            Logout
                        </button>
                    </Link>
